...
> **原始路径**: `Anthropic/claude-code/skills/design-sync/package-capture.mjs`  
...
for (const c of comps) {
  ...
  // as the empty-set sentinel ('\u2205') - a phantom contract change that clears a perfectly valid grade.
  let cardHead;
